...
# FIX #66: Module-level pyautogui init kaldırıldı. Ekran boyutu lazy
# fonksiyon ile alınır; eski `screen_width`/`screen_height` global
# isimleri yine dışarıdan import edilebilir (lazy property gibi).
